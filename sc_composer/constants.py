...
PROMPT_PROFILES = {
    ...
    "Pony Diffusion V6 XL": {
        ...
        "neg": "score_4, score_5, score_6, source_pony, source_furry, source_cartoon, 3d, realistic, lowres, bad anatomy, bad hands, error, missing fingers, extra digit, fewer digits, cropped, worst quality, low quality"
    },
    "Illustrious XL": {
        ...
        "neg": "lowres, (bad), text, error, missing, extra, fewer, cropped, jpeg artifacts, worst quality, low quality, watermark, displeasing, ugly, incomplete, deformed, blurry"
    },
    "Animagine XL 3.x": {
        "order": ["quality", "rating", "subject", "environment", "lighting", "camera", "style"],
        "ref": "masterpiece, best quality, very aesthetic, absurdres, highres",
        "neg": "lowres, (bad), text, error, missing, extra, fewer, cropped, jpeg artifacts, worst quality, low quality, watermark, displeasing, ugly, incomplete"
    },
    "SD 1.5 (Anime / Danbooru)": {
        ...
        "neg": "lowres, bad anatomy, bad hands, text, error, missing fingers, extra digit, fewer digits, cropped, worst quality, low quality, normal quality, jpeg artifacts, signature, watermark, username, blurry, artist name"
    }
}
