...
- **v1.0 (Stable)**: **正式版リリース**。バグ修正15件統合、カテゴリ一括選択機能、UI整理（アコーディオン初期化設定）、および安定性の大幅向上。
...
### ✨ プロンプト自動生成 (WD14 Tagger連携)
画像をアップロードするだけで、構図やスタイル、詳細なタグ（NSFW含む）を自動抽出。カテゴリ別の抽出フィルタや、自分好みのワードへ変換する辞書機能も搭載しています。

![プロンプト自動生成](docs/images/ui_autogen_ja.png)
